...
//                    }
                    ...
                    if (newValue <= cfg.scaleMax/4)
                    {
                        color = "#ff7a7a";
                    }
                    if (newValue > cfg.scaleMax/4 && newValue <= cfg.scaleMax/2)
                    {
                        color = "#e6ca80";
                    }
                    if (newValue > cfg.scaleMax/2 && newValue <= (cfg.scaleMax*3)/4 )
                    {
                        color = "#82f5ff";
                    }
                    if (newValue > (cfg.scaleMax*3)/4)
                    {
                        color = "#b8e986";
                    }
                    ...
                    if (newValue !== undefined) {
                        path += '<text text-anchor="middle" x="' + center + '" y="' + (center + 15) + '">' +
